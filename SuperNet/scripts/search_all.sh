...
#CKPT=seed-${SEED}-opt5-wotrash-decom5-16-20-64-250-balanced/seed-${SEED}-last.pth # K=2
CKPT=seed-${SEED}-opt5-wotrash-decom5-5-20-30-64-750-balanced/seed-${SEED}-last.pth # K=3
