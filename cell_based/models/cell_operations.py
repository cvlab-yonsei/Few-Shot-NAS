...
NAS_BENCH_201    = ['none', 'skip_connect', 'nor_conv_1x1', 'nor_conv_3x3', 'avg_pool_3x3'] # original
#NAS_BENCH_201    = ['none', 'skip_connect', 'avg_pool_3x3', 'nor_conv_1x1', 'nor_conv_3x3']
DARTS_SPACE      = ['none', 'skip_connect', 'avg_pool_3x3', 'max_pool_3x3', 'dil_sepc_3x3', 'dil_sepc_5x5', 'dua_sepc_3x3', 'dua_sepc_5x5']
...
class SepConv(nn.Module):
  '''
  This is equivalent to 'DilConv' in https://github.com/quark0/darts/blob/master/cnn/operations.py#L35
  '''
  def __init__(self, C_in, C_out, kernel_size, stride, padding, dilation, affine, track_running_stats=True):
...
class DualSepConv(nn.Module): 
  '''
  This is equivalent to 'SepConv' in https://github.com/quark0/darts/blob/master/cnn/operations.py#L50
  '''
  def __init__(self, C_in, C_out, kernel_size, stride, padding, dilation, affine, track_running_stats=True):
...
class FactorizedReduce(nn.Module):
  ...
  def forward(self, x):
    if self.stride == 2:
      x = self.relu(x)
      y = self.pad(x) # NOTE: This is different from 'FactorizedReduce' in https://github.com/quark0/darts/blob/master/cnn/operations.py 
